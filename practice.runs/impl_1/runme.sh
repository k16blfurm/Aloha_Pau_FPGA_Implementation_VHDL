...
HD_PWD='C:/Users/Blaine/Documents/GitHub/Aloha_Pau_FPGA_Implementation_VHDL/practice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practice.tcl -notrace
