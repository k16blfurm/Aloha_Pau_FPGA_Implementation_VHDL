...
HD_PWD='C:/Users/Blaine/Documents/GitHub/Aloha_Pau_FPGA_Implementation_VHDL/practice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice.tcl
